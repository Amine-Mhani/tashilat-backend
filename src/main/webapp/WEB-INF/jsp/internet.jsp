...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js">Title</script>
</head>
        ...
        <div class="row justify-content-center">
            <div class=" col-lg-6 col-md-8">
                <div class="card p-3">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h2 class="heading text-center">Internet</h2>
                        </div>
                    </div>
                    <form onsubmit="event.preventDefault()" class="form-card">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="input-group"><input type="text" name="Numero" placeholder="#"> <label>Subscription Identification Code : </label>
                                </div>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="input-group"><input type="text" name="Numero" placeholder="email@gmail.com"> <label>Email</label>
                                </div>
                            </div>
                        </div>
                        <div class="row justify-content-center">
